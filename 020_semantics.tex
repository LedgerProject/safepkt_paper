...
leftvalues, as shown below. Def.~\ref{def:type} is a translation of
...
It turns out that the dependencies between leftvalues model the pattern of the recursion
in Def.~\ref{def:type}, as proved in Prop.~\ref{prop:acyclicity}.
