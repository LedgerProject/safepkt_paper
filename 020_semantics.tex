...
\begin{definition}[Borrowed locations]
  ...
  Location $l$ is \emph{non-mutably borrowed} in $h$
  if there exists $\ell'\in\Locs$ such that $\ell'\to\ell$.
  Location $l$ is \emph{mutably borrowed} in $h$
  if there exists $\ell'\in\Locs$ such that $\ell'\leadsto\ell$.
  Location $l$ is \emph{borrowed} in $h$
...
\begin{definition}[Consistent heaps]
  ...
  \begin{enumerate}
  \item no location is at the same time mutably and not mutably borrowed in $h$
