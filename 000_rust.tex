...
\newcommand{\locread}{\mathsf{loc_+}}
\newcommand{\locreada}{\mathsf{loc_+^\alpha}}
...
\begin{abstract}
  \input{001_abstract}
  \keywords{Type system, Borrowing, Rust, Static Analysis, Abstract Intepretation.}
\end{abstract}

\input{010_introduction}
\input{020_semantics}
\input{030_abstract_semantics}
\input{040_implementation}
