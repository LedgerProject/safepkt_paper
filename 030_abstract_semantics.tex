...
\begin{definition}\label{def:abstract_borrow}
  ...
  \begin{align*}
    ...
    \beta_\to(\mathtt{box}\ \mathsf{T},\mathsf{w})&=\beta_\to(\mathsf{T},\mathsf{w})\\
    \beta_\to(\mathtt{dangling},\mathsf{w})&=\mathit{false}\\
    \beta_\to(\mathtt{any},\mathsf{w})&=\mathit{true}.
  \end{align*}
  ...
  \begin{align*}
    ...
    \beta_\leadsto(\mathtt{box}\ \mathsf{T},\mathsf{w})&=\beta_\leadsto(\mathsf{T},\mathsf{w})\\
    \beta_\leadsto(\mathtt{dangling},\mathsf{w})&=\mathit{false}\\
    \beta_\leadsto(\mathtt{any},\mathsf{w})&=\mathit{true}.
  \end{align*}
