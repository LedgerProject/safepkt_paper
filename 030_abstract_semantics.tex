...
\begin{proof}
  ...
  lower bound. Let $I\subseteq\mathbb{N}$ and
  $\{a_i\}_{i\in I}\subseteq\mathbb{AS}_\kappa$. We prove that
  $\mu_I=\sqcap_{i\in I}a_i$ is the greatest lower bound of $\{a_i\}_{i\in I}$.
  Let $i\in I$. If $\mu_I$ is empty or $a_i=\top$ then we have
  $\mu_I \sqsubseteq a_i$. If $\mu_I = \top$ then $\{a_i\}_{i\in I}=\{\top\}$,
  so we have $a_i=\top$, hence $\mu_I \sqsubseteq a_i$.
  Otherwise (\textit{ie.} $\mu_I\neq\emptyset$, $\mu_I\neq\top$ and
  $a_i\neq\top$), let $x\to^m t\in \mu_I$. Then, for all $j\in I$ there is a
  binding $x\to^m t_j$ in $a_j$ and $t = \sqcap_{j\in I}t_j$. In particular,
  there is a binding $x\to^m t_i$ in $a_i$ and, by Lem.~\ref{lemma:glb-type},
  $\sqcap_{j\in I}t_j \sqsubseteq t_i$. Consequently, we have
  $\mu_I \sqsubseteq a_i$. Hence, we have proved that $\mu_I$ is a lower bound
  of $\{a_i\}_{i\in I}$. It remains to prove that it is the greatest.
