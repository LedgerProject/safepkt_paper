...
\begin{proof}
  ...
  \begin{itemize}
    ...
    Moreover, by Def.~\ref{def:abstract_location_for_reading},
  ...
  \item (Induction step) Suppose that the thesis holds for $\mathsf{w}$. Let us prove it
    ...
    \begin{itemize}
      ...
      and $\ell'\sim_{\rho\star h}\borrow\{\mathsf{w}_1,\ldots,\mathsf{w}_n\}$.
      By Def.~\ref{def:abstract_location_for_reading},
      $\locreada(\mathtt{*}\mathsf{w},a)=\langle t_1\sqcup\cdots\sqcup t_n,\mathit{true}\rangle$
      with $\locreada(\mathsf{w}_i,a)=\langle t_i,b_i\rangle$
      and $t_1\sqcup\cdots\sqcup t_n$ exists. Hence the second point of the thesis holds.
      We must prove that $\ell'\approx_{\rho\star h}t_1\sqcup\cdots\sqcup t_n$.
